    ...
    <ThemeProvider theme={color_one}>
      ...
      >
        <Typography variant="h4" component="h4">
          Si tienes trabajo por hacer ¡Ourker está contigo!
        </Typography>
        <Typography>
          Miles de trabajadores disponibles para que encuentres el que se ajuste
        ...
        >
          ...
          <Grid
            ...
            lg={6}
            xl={6}
            sx={{ alignItem: "center", px: "auto", mx: "auto" }}
          >
            <Box
              sx={{
                display: "flex",
            ...
            >
              <Typography sx={{ px: 1, fontSize: 20, fontWeight: "bold" }}>
        ...
        >
          <Typography sx={{ fontWeight: "bold", fontSize: 25, margin: "auto" }}>
            Publica tu trabajo en el portal de freelancing de mayor popularidad
            en México.
          </Typography>
          <Grid
            sx={{
          ...
          >
            <Grid item xs={12} lg={4} sx={{ m: "auto" }}>
              ...
              >
                <CheckIcon
                  sx={{ color: color_one.primary.main, fontSize: 75 }}
                />
                <Typography>
                  Publica, comparte y ofrece tu trabajo y/o servicios
                  completamente gratis en la zona en que te encuentres para
                  facilitar tus traslados y disminuir tiempos.
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} lg={4} sx={{ m: "auto" }}>
              ...
              >
                ...
                />
                <Typography>
                  Si trabajas solo o en compañia, eres freelancer, parte de un
                  taller, o tienes un proyecto en mente y necesitas
                  colaboradores, encuentra y se encontrado por usuarios en los
                  alrededores de tu ubicacion preferida.
                </Typography>
              </Box>
            </Grid>
            <Grid item xs={12} lg={4} sx={{ m: "auto" }}>
              ...
              >
                ...
                <Typography>
                  {" "}
                  Compara, contacta, califica resultados y compartelos para
                  futuros usuarios. Observa la lista de trabajos previos de los
                  Profesionistas y elige el mas conveniente para ti.
                </Typography>
              </Box>
            </Grid>
          </Grid>
