    ...
    <Grid spacing={2} style={{
        ...
        <Paper elevation={3} sx={{
            ...
            <Box sx={{display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"space-between"}}>
                <TextField id="outlined-basic" label="Write a comment..." variant="outlined" className={classes.WriteComment}/><SendIcon sx={{mx:"10px", color:color_one.primary.main, fontSize:"30px"}}/>
            </Box>
